            ...
            <form method="POST" id="anularForm" action="{{ route('anularsolicitudvehiculopolicia-pendiente') }}"
                ...
                <div class="mt-4 w-full">
                    ...
                    @if (Auth::user()->rol() == 'administrador')
                        <label class="flex items-center mt-2">
                            <input type="checkbox" name="motivo" value="no_hay_vehiculos_disponibles" class="mr-2">
        ...
        <script>
            $(document).ready(function() {
                $('#btnConsultarVehiculos').click(function() {
                    ...
                    let tipoVehiculo = '{{ $solicitud['tipo_vehiculo'] }}'; // Se pasa como string correctamente
