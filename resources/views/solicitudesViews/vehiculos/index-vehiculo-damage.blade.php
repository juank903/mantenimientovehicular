            ...
            <form method="POST" class="flex flex-col md:flex-row gap-4" action=""{{ route('guardarsolicitudvehiculo') }}"">
                ...
                <div class="w-full md:w-1/2 p-4 ">
                    ...
                    <div>
                        ...
                        <x-text-input id="{{session('personal')['id']}}" class="block mt-1 w-full" type="text" name="nombres"
                            value="{{
                            session('personal')['primerapellido_personal_policias']. ' ' .
                ...
                <div class="w-full md:w-1/2 p-4">
                    ...
                    <div class="mb-4" >
                        ...
                        <input class="text-xs" type="date" id="fecharequerimiento" name="fecharequerimiento" required>
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>
                    <!-- Tipo prioridad -->
                    <div class="mt-4">
                    ...
                    <div>
                        ...
                        <x-select required name="tipovehiculo" :items="$datosTipoVehiculo" index="0" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>
