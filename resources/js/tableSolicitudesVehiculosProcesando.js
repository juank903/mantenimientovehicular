$(document).ready(function () {
    let table = $('#solicitudesvehiculos-procesando').DataTable({
        responsive: true,
        processing: true,
        serverSide: true,
        ajax: {
            url: `/api/listarsolicitudesvehiculos?estado=Procesando`,
            type: 'GET',
    ...
    $(document).on('click', '.show-button', function () {
        ...
        const url = `/mostrarentregarecepcionvehiculo/Procesando/entregado/show/${id}`;
